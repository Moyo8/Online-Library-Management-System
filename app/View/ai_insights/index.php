<?php
/**
 * AI Insights Chat View (Admin)
 * Renders as a content fragment inside layouts/admin.php
 */
?>

<style>
/* ========================================
   AI CHAT — Scoped Styles (Admin)
...
<div class="mb-4 dashboard-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="mb-2 fw-bold">🤖 AI Insights</h1>
            <p class="text-muted mb-0">Ask about library analytics, trends, and user behavior patterns.</p>
        </div>
    </div>
</div>
...
<div class="ai-chat-wrapper">
    ...
    <div class="ai-sessions-panel">
        <div class="ai-sessions-header">
            <h6>💬 Chats</h6>
            <a href="<?= url('/ai/insights/new') ?>" class="ai-new-chat-btn">
                ＋ New
            </a>
        </div>
        <div class="ai-sessions-list">
            ...
            <?php else: ?>
                <?php foreach ($recent_sessions as $sess): ?>
                    <a href="<?= url('/ai/insights?session_id=' . $sess['id']) ?>"
                       class="ai-session-item <?= ($sess['id'] == $current_session_id) ? 'active' : '' ?>">
                        ...
                        <form method="POST" action="<?= url('/ai/insights/delete') ?>"
    ...
    <div class="ai-chat-panel">
        <div class="ai-chat-topbar">
            ...
            <div class="ai-chat-topbar-info">
                ...
                <small>AI-powered library analytics assistant</small>
            </div>
        </div>
        ...
        <div class="ai-messages-area" id="aiMessagesArea">
            <?php if (empty($chat_history)): ?>
                <div class="ai-welcome">
                    ...
                    <p>Ask me about library analytics, book trends, user engagement, or any data-driven question about your library.</p>
                    <div class="ai-suggestions">
                        <span class="ai-suggestion-chip" data-suggestion="What are the most popular books this month?">📚 Popular books</span>
                        <span class="ai-suggestion-chip" data-suggestion="Show me user engagement trends">📈 User trends</span>
                        <span class="ai-suggestion-chip" data-suggestion="Which genres are trending?">🏷️ Trending genres</span>
                        <span class="ai-suggestion-chip" data-suggestion="How many overdue books are there right now?">⏰ Overdue books</span>
                        <span class="ai-suggestion-chip" data-suggestion="Give me a summary of library activity this week">📊 Weekly summary</span>
                    </div>
                </div>
            <?php else: ?>
        ...
        <div class="ai-input-bar">
            <form method="POST" action="<?= url('/ai/insights?session_id=' . $current_session_id) ?>" id="aiChatForm" style="display:flex;gap:0.75rem;width:100%;align-items:center;">
                <?= csrf_field() ?>
